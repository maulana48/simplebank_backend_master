...
/*
Transfer api authorization rule :
- transfer account : only transfer from account of logged user
*/
...
func (server *Server) createTransfer(ctx *gin.Context) {
	...
	// check if source account is own by logged user
	...
	// dont need to check where the transfer target is
