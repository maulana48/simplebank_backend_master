...
// Source: github.com/maulana48/backend_master_class/simplebank/db/sqlc (interfaces: Store)
...
// UpdateAccount1 mocks base method
func (m *MockStore) UpdateAccount1(arg0 context.Context, arg1 db.UpdateAccount1Params) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateAccount1", arg0, arg1)
	ret0, _ := ret[0].(error)
	return ret0
}

// UpdateAccount1 indicates an expected call of UpdateAccount1
func (mr *MockStoreMockRecorder) UpdateAccount1(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateAccount1", reflect.TypeOf((*MockStore)(nil).UpdateAccount1), arg0, arg1)
}
